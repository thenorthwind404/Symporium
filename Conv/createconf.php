    ...
    <div class = "form_inner_design">
        <script>
            function checkdates()
            {
                ...
                if(d2<d1)
                {
                    alert("The start date cannot be less than end date");
        ...
        <form name="myform" action="conf.php" method="post" enctype="multipart/form-data">
            <table>
                <col width = "300">
                    <col width = "1000">
                    ...
                    <td>       
                       <input type = 'date' name = 'sdate' id = 'date1' required>
                    </td>
                </tr>
                  <tr>
                    <td class = 'bold'>
                    ...
                    <td>       
                       <input type = 'date' name = 'edate' id = 'date2' onblur = 'checkdates()' required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name='confname' placeholder="Maximum 100 characters allowed" maxlength = 100 required>
                    </td>
                </tr>
                <tr>
                    <td class = 'bold'>
                    ...
                    <td>
                        <input type="text" name='confloc' placeholder="Maximum 100 characters allowed" maxlength = 100 required>
                    </td>
                </tr>
                <tr>
                    <td class = 'bold'>
                    ...
                    <td>
                        <input type="text" name='topics' placeholder="Enter the topics covered in this conference" required>
                    </td>
                </tr>
                    <td class = 'bold'>
                        Conference Date
            ...
            <br/>
            <br/>
                <input type="submit" value="Create Conference" name="save">
        </form>
    </div>
