  ...
  <a href="#" id="con">Terms and Conditions</a>
            ...
            <?php 
                ...
                <div id = 'spacing'>
                    ...
                    <h2>Type the abstract of your paper in the text box given below</h2>
                    <br/>
                </div>
               
                <form method = 'POST' action = './abs2.php'> 
                    <table>                           
                <tr>
                    <td>
                        <textarea type="textarea" cols="40" rows="5" name='abstract'></textarea>
                    </td>
                </tr>
                                         </table>
                                         <br/>
