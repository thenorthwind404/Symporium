...
<div id="mySidenav" class="sidenav">
  ...
  <a href="#" id="con">Terms and Conditions</a>
            ...
            <div class="mainbox">
            <?php 
                        if(isset($_GET['confid'])) {$_SESSION['curr_confid'] = $_GET['confid'];}
                        $x = $_SESSION['curr_confid'];
                ...
                <div id = 'spacing'>
                    ...
                    <h2>Name your file as AuthorNames_Fullpaper</h2>
                    <br/>

               
                <form method = 'POST' action = './fullpap2.php'  enctype="multipart/form-data"> 
                
                    <input type = 'file' name = 'fullpaper' id = 'fullpaper' >
                    <h3>Accepted file types : .pdf .docs .zip</h3>
                    <br/>
                    <br/>
                    <input type="submit" value="Submit Fullpaper" name="save" >
                </form>
                </div>
            </div>
        </div>
