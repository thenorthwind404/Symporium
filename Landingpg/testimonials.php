...
<html>
  ...
  <ul>
    ...
    <li><a href="./sub.php"><i class="fa fa-book"></i><span>Installation</span></a></li>w
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="#" id="con">Terms and Conditions</a>
            ...
            <div class="mainbox">
                ...
                <div class="div1">Testimonials</div>
					 <br>
<div class="div2">
<p>I'm very impressed by the
 paper assignment algorithm of
 your system - definitely the
 best result I ever got ... Both
 Thomas and I would like to
 use it for ICDT

-Leonid Libkin (Professor
, University of Edinburgh)<p><br>
The website is comprehensive and easy to use as well - Bruce Banner, Harvard University<p><br>
<p>I would recommend using this website for my class due to it's accessibility and flawless execution. - Shota Aizawa, UA High School<p>
